...
1.<br> We decide to use 5 factors with manual analysis


First component means to what extend the respondent is passionate about boating
Second component preference to price
third component experience
fourht prestige
five low price
...
# Please use numbers, not column names, e.g. c(1:5, 7, 8) uses columns 1,2,3,4,5,7,8
segmentation_attributes_used = c(10,19,6,12,3) #c(10,19,5,12,3) 
