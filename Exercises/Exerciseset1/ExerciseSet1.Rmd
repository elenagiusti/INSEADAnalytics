...
**Your Answers here:**
1.The ticker AAPL is downloaded after the ticker SPY in line 8 of data Set 1 . IN R code : mytickers = c("SPY", "AAPL")"\nDownloading ticker  AAPL  ..."

2. 
<br> round(100*sum(StockReturns[,2],1)
[1] 596.5
...
3.To get the data for Yahoo this part of the code should be modified in line 8 of dataSet1 mytickers = c("SPY", "AAPL","YHOO") 
...
**Your Answers here:**
1.
<br> ncol(transposedData)
[1] 4034
<br> nrow(transposedData)
[1] 3

The row of transpose data should be two if you use the original data with only SPY and AAPL

2.
<br> transposedData = t(StockReturns[,c("SPY","AAPL")])
...
**Your Answers here:**
1. You have to change the startDate to  "2000-12-29"in dataSet1.R and you got data starting from the 2nd of january since the first of january stock market is closed.
2.
Yes I have created a new porfolio adding GOOG and TSL on the data set in the part of the code line 8
...
**Your Answers here:**
1.It gives you as a result 20 and tell you how many times the data in the matrix twentydays(myData) match the Stock returns.
2. The two databases cannot be merged since they are in different extensions/format.Therefore we have an error message.
